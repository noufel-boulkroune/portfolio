          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              <motion.a
                ...
                className="ml-4 px-5 py-2.5 text-sm font-semibold rounded-xl bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/30 text-primary hover:border-primary/60 hover:bg-primary/20 transition-all duration-300"
            ...
            {/* Mobile Menu Button */}
            <motion.button
              className="md:hidden relative w-10 h-10 flex items-center justify-center rounded-xl bg-dark-200/80 border border-white/10"
          ...
          <>
            ...
            >
              <div className="flex flex-col h-full pt-20 pb-8 px-6">
                {/* Close button */}
                <motion.button
                  className="absolute top-6 right-6 w-10 h-10 flex items-center justify-center rounded-xl bg-dark-200/80 border border-white/10"
                  onClick={() => setIsMenuOpen(false)}
                  whileTap={{ scale: 0.95 }}
                >
                    ...
                    <motion.a
                      ...
                      className={`px-4 py-3 text-lg font-medium rounded-xl transition-all duration-300 ${
                        activeSection === link.id
                          ...
                          : "text-light-300 hover:bg-dark-200 hover:text-white"
                      }`}
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-6 px-4 py-3 text-center text-lg font-semibold rounded-xl bg-gradient-to-r from-primary to-secondary text-dark transition-all duration-300"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                <div className="mt-auto pt-8 border-t border-white/5">
                  <p className="text-sm text-light-300/60 mb-4">Get in touch</p>
                  <div className="flex gap-4">
                    <a
                      href="https://github.com/noufel-boulkroune"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 flex items-center justify-center rounded-xl bg-dark-200 border border-white/10 text-light-300 hover:text-primary hover:border-primary/30 transition-all duration-300"
                    >
