...
const HeroSection = () => {
  ...
  return (
    <section className="pt-20 sm:pt-32 pb-10 min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <motion.div
      ...
      >
        ...
        {/* Skills Section */}
        <div className="mt-16">
          <h2 className="text-3xl font-semibold mb-6 text-center lg:text-left bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
            Skills
          </h2>

          {/* Mobile Grid */}
          <div className="md:hidden grid grid-cols-2 sm:grid-cols-3 gap-4 place-items-center">
